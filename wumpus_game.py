...
def create_all_percept_list(row_size,column_size):
        tile = Tile(False,False,False,False,False,False,False)
        new_list = [[tile for x in range(column_size)] for x in range(row_size)]
        return new_list
...
def update_map_insights(element_type,index):
        ...
        if element_type == agent_image:
                ...
                all_map_percept_list[i][j].glitter = True
                ...
                for neighbour in adjacent_caves:
                        ...
                        print('i,j ::',i,' ',j)
                        strench_in_cave[neighbour_i][neighbour_j] = True
                ...
                pit_in_cave[i][j] = 1
                all_map_percept_list[i][j].pit = True
                adjacent_caves = get_adjacent_caves(i,j)
                image_add_list = []
                ...
                for neighbour in adjacent_caves:
                        ...
                        all_map_percept_list[i][j].breeze = True
